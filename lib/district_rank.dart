...
class DistrictRankWidget extends StatelessWidget {
  const DistrictRankWidget({Key? key}) : super(key: key);
...
class DistrictRankHome extends ConsumerStatefulWidget {
  const DistrictRankHome({Key? key}) : super(key: key);

  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends ConsumerState<DistrictRankHome> {
